...
void MyWindow::print_cell_data(MyToggleButtons *button){
	std::cout<<"\noszlopindex: "<<button->i<<", sorindex: "<<button->j<<", érték: "<<button->data[button->i][button->j]
	         <<", terminated: "<<button->is_terminated();
}
...
//lehet, de minden helyre új gombot szeretnék létrehozni
